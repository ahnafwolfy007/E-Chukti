  ...
  return (
    <div className="min-h-screen flex">
        ...
        >
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <Button variant="ghost" className="w-full border border-neutral-300">
      ...
      <motion.div
        ...
        className="hidden lg:flex flex-1 bg-gradient-to-br from-primary-500 to-purple-600 items-center justify-center p-12"
      >
        <div className="text-white text-center max-w-md">
          ...
          <p className="text-white/80 text-lg">
            Join thousands of businesses streamlining their legal documentation with E-Chukti
          </p>
        </div>
      </motion.div>
    </div>
